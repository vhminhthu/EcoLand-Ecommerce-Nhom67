            ...
            <div className="bg-white text-xl font-bold rounded-xl shadow-xl px-5 py-4 w-auto h-fit flex justify-between items-center">
                ...
                <div className="flex justify-between items-center text-black gap-4">
                    <div className="flex gap-4">
                        <div
                            className="hover:bg-slate-100 rounded-lg flex items-center justify-center w-12 h-12 cursor-pointer"
                            onClick={() => setIsOpen(true)}
                        >
                            <MdOutlineEmail className="text-xl" />
                        </div>

                        <div className=" rounded-lg flex items-center justify-center w-12 h-12">
                            <img
                                src={user.anhND}
                                alt="profile"
